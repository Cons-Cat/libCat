...
$test(meta_common_comparison) {
   ...
   static_assert(is_same<
                 common_comparison_category_t<strong_ordering, weak_ordering>,
                 weak_ordering>);

   static_assert(is_same<
                 common_comparison_category_t<weak_ordering, strong_ordering>,
                 weak_ordering>);
   ...
   // result to `void`.
   static_assert(is_same<common_comparison_category_t<int>, void>);
   static_assert(
      is_same<common_comparison_category_t<strong_ordering, int>, void>
   );
}
