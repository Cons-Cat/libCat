...
TEST(test_alloc) {
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ =
        allocator.inline_align_realloc_multi(inline_alloc, 8u, 10u).value();
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_unalign_xrealloc_multi_to(allocator, inline_alloc,
                                                        10u);
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_recalloc_multi_to(allocator, inline_alloc, 10u)
                 .value();
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_unalign_xrecalloc_multi_to(allocator,
                                                         inline_alloc, 10u);
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_resalloc_multi_to(allocator, inline_alloc, 10u)
                 .value();
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_unalign_xresalloc_multi_to(allocator,
                                                         inline_alloc, 10u);
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_align_rescalloc_to(allocator, inline_alloc, 8u)
                 .value();
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ = allocator.inline_rescalloc_multi_to(allocator, inline_alloc, 10u)
                 .value();
    allocator.free(inline_alloc);
    ...
    inline_alloc = allocator.inline_alloc<int4>().value();
    auto _ =
        allocator.inline_unalign_rescalloc_multi(inline_alloc, 10u).value();
    allocator.free(inline_alloc);
