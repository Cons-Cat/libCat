...
expect_exact("cat_gdb_overflow_reference_value", "31")
expect_exact("cat_gdb_atomic_value", "42")
expect_exact("cat_gdb_atomic_reference_value", "52")
expect_exact("cat_gdb_const_atomic_value", "62")
expect_exact("cat_gdb_memory_order_reference_value", "42")
expect_exact("cat_gdb_const_memory_order_reference_value", "62")
expect_exact("cat_gdb_atomic_overflow_value", "72")
expect_exact("cat_gdb_atomic_wrap_release_value", "72")
expect_exact("cat_gdb_atomic_release_wrap_value", "72")
